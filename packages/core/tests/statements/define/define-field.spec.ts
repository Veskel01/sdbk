...
describe('DEFINE FIELD', () => {
  describe('Basic field definitions', () => {
    it('parses basic field with type', () => {
      ...
      expectTypeOf<schema['tables']['user']['fields']['name']>().toMatchTypeOf<{
        name: 'name';
        type: string;
      }>();
    });
  ...
  describe('Type variations', () => {
    ...
    it('parses record types', () => {
      ...
      expectTypeOf<schema['tables']['post']['fields']['author']['type']>().toMatchTypeOf<{
  ...
  describe('Permissions', () => {
    ...
    it('parses field with PERMISSIONS NONE', () => {
      ...
      expectTypeOf<
        Schema['tables']['user']['fields']['internal_id']['permissions']
      >().toMatchTypeOf<{
        full: false;
        none: true;
      }>();
