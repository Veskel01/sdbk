...
type _ExtractUserLevel<S extends string> =
...
// Extract ROLES
type _ExtractRoles<S extends string> =
  Upper<S> extends `${string}ROLES ${infer Rest}`
    ? _ParseRoleList<Rest>
...
// Extract DURATION
type _ExtractUserDuration<S extends string> =
